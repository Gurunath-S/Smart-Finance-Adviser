...
function Expenses() {
    const { expenses, getExpenses, deleteExpense, updateExpense, totalExpenses, incomes } = useGlobalContext();
    ...
    useEffect(() => {
        getExpenses({ search, category: categoryFilter, from: fromDate, to: toDate, page, limit: LIMIT });
                ...
                <div className="income-content">
                    ...
                    <div className="incomes">
                        ...
                        <div className="pagination">
                            ...
                            <span>Page {page}</span>
                            <button disabled={expenses.length < LIMIT} onClick={() => setPage(p => p + 1)}>Next →</button>
                        </div>
                    </div>
                </div>
            </InnerLayout>
